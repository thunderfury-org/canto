...
export const initialTemplates = [
  {
    ...
    description:
      '生产级透明代理模板：包含完整的 DNS、Inbounds/Tailscale 端点、分流策略组与 18 条路由规则',
  ...
  },
  {
    ...
    content: {
      ...
      node_groups: [{ type: 'urltest', tag: '全部节点', outbounds: ['{.*}'] }],
      rule_sets: [
        {
          tag: ['cn'],
          type: 'remote',
...
export const initialSources = [
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        tls: {
          enabled: true,
          server_name: 'hk02.fastspeed.xyz',
          reality: { enabled: true, public_key: 'AbCdEf0123456789' },
        },
      },
      {
        type: 'trojan',
  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        tls: {
          enabled: true,
          server_name: 'us.myworld.org',
          reality: { enabled: true, public_key: 'PublicKeyReality99' },
        },
      },
      {
        type: 'shadowsocks',
